...
1. **[QUICK_START.md](QUICK_START.md)** ← 3-step quick start (recommended)
2. **[DEPLOYMENT_CONFIG.md](DEPLOYMENT_CONFIG.md)** ← Choose your deployment method
3. **[DOCS_INDEX.md](DOCS_INDEX.md)** ← Complete documentation map
4. **[ARCHITECTURE.md](ARCHITECTURE.md)** ← System design & structure
5. **[DEPLOYMENT.md](DEPLOYMENT.md)** ← Detailed deployment procedures
6. **[API_TESTING_GUIDE.md](API_TESTING_GUIDE.md)** ← API endpoint reference

### 🚀 Quick Deployment (Choose One)

**Option 1: Docker (Easiest - 5 min)**
```bash
docker-compose up -d
...
- **Linux/Ubuntu**: `sudo bash scripts/ubuntu-deploy.sh`
- **Windows**: `powershell -ExecutionPolicy Bypass -File scripts\windows-deploy.ps1`
- **Any OS with Docker**: `bash scripts/docker-deploy.sh`

**Option 3: Manual Setup**
- See [QUICK_START.md](QUICK_START.md) or [DEPLOYMENT_CONFIG.md](DEPLOYMENT_CONFIG.md)
...
### Before Deploying
1. **[PRE_DEPLOYMENT_CHECKLIST.md](PRE_DEPLOYMENT_CHECKLIST.md)** - Complete verification checklist
2. **[DEPLOYMENT_CONFIG.md](DEPLOYMENT_CONFIG.md)** - Configuration guide for your platform
3. **[scripts/README.md](scripts/README.md)** - Deployment scripts documentation
...
#### Backend API Endpoints
| Resource | Endpoints | Authentication | Role |
|----------|-----------|-----------------|------|
| **Topics** | GET, POST, PUT/:id, DELETE/:id | ✅ | Admin |
| **Indicators** | GET, POST, PUT/:id, DELETE/:id | ✅ | Admin |
| **Periods** | GET, POST, PUT/:id, DELETE/:id | ✅ | Admin |
| **Assignments** | GET, POST, PUT/:id, DELETE/:id | ✅ | Admin |
| **Results** | GET, POST, PUT/:id, DELETE/:id | ✅ | All Users |
| **Departments** | GET, GET/:id | ✅ | All Users |
...
- ✅ Dashboard: Overview of 6 management modules
- ✅ Topics: CRUD interface with data table
- ✅ Indicators: CRUD with topic & evidence type mapping
- ✅ Periods: CRUD with Buddhist year support & active status
- ✅ Assignments: Assign evaluators to evaluatees per period
- ✅ Results: View evaluation results with CSV export
- ✅ Monitor: Department-level progress tracking with statistics

**Evaluator Dashboard** (`/eval/`)
- ✅ Tasks: View assigned evaluations with period filter
- ✅ Scoring: Main evaluation form by topic (score 1-4 or yes/no)
- ✅ Results: View submitted evaluations grouped by evaluatee

**Evaluatee Dashboard** (`/me/`)
- ✅ Evaluation: Overview of personal results by topic
- ✅ Indicators: Detailed indicators view with evidence & scores
- ✅ Progress: Overall progress tracking with statistics & per-topic breakdown
...
**Authentication**
- [ ] Admin login: admin@ccollege.ac.th / admin123
- [ ] Evaluator login: eva.me@ccollege.ac.th / password123
- [ ] Evaluatee login: t.it01@ccollege.ac.th / demo123
- [ ] Invalid credentials rejected
- [ ] Token expires after 2 hours

**Admin Features** (/admin/)
- [ ] Topics: Create, read, update, delete
- [ ] Indicators: CRUD with evidence type mapping
- [ ] Periods: CRUD with active status toggle
- [ ] Assignments: Create evaluator-evaluatee pairs
- [ ] Results: View and export to CSV
- [ ] Monitor: Show department progress statistics

**Evaluator Workflow** (/eval/)
- [ ] Tasks: List assigned evaluations
- [ ] Scoring: Enter 1-4 scores and yes/no answers
- [ ] Save as draft and submit evaluation
- [ ] Results: View submitted evaluations

**Evaluatee Dashboard** (/me/)
- [ ] View personal evaluation results
- [ ] View indicators and uploaded evidence
- [ ] Track overall progress with statistics
- [ ] See progress breakdown by topic
...
- Node.js v18+
- MySQL 8.0+
- 2GB RAM, 20GB storage, HTTPS certificate
...
```bash
docker-compose up -d
# Services: MySQL (3306), phpMyAdmin (8080), Backend (7000), Frontend (3000)
```
